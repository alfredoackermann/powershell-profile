...
if (!(Test-Path -Path $PROFILE -PathType Leaf)) {
    try {
        ...
        Invoke-RestMethod https://github.com/alfredoackermann/powershell-profile/raw/main/Microsoft.PowerShell_profile.ps1 -OutFile $PROFILE
...
if ((Test-Path -Path $PROFILE) -and (winget list --name "starship" -e) -and ($fontFamilies -contains "Cascadia Code")) {
